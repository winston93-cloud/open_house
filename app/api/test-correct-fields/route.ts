...
export async function GET(request: NextRequest) {
  try {
    console.log('🧪 TEST CON CAMPOS CORRECTOS: Usando IDs reales...');
    ...
    // Payload CON CAMPOS CORRECTOS: Usando IDs reales
    const testPayload = [
      {
        name: "TEST CON CAMPOS CORRECTOS",
        price: 0,
          ...
          contacts: [
            {
              ...
              custom_fields_values: [
                {
                  field_id: 557100, // ID real del campo Email
                  values: [{ value: "test@test.com", enum_code: "WORK" }]
                },
                {
                  field_id: 557098, // ID real del campo Teléfono
    ...
    console.log('📤 Payload CON CAMPOS CORRECTOS:', JSON.stringify(testPayload, null, 2));
