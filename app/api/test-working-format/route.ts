...
export async function GET(request: NextRequest) {
  try {
    console.log('🧪 TEST FORMATO QUE FUNCIONA: Solo name con corchetes...');
    ...
    // Payload QUE FUNCIONA: Solo name con corchetes
    const payload = {
      name: ["FORMATO QUE FUNCIONA TEST"]
    };
    
    console.log('📤 Payload QUE FUNCIONA:', JSON.stringify(payload, null, 2));
