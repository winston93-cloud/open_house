...
export async function GET(request: NextRequest) {
  try {
    console.log('🧪 TEST SOLO TELÉFONO: Probando diferentes enum_codes...');
    ...
    // Probar con MOB (móvil)
    console.log('📱 Probando con enum_code: MOB...');
    ...
    if (contactResponse.ok) {
      ...
      console.log('📥 Respuesta:', JSON.stringify(contactData, null, 2));
