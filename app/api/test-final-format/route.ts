...
export async function GET(request: NextRequest) {
  try {
    console.log('🧪 TEST FORMATO FINAL: Objeto simple...');
    ...
    // Payload FINAL: Objeto simple (como Facebook)
    const payload = {
      name: "FORMATO FINAL TEST",
      price: 0,
      pipeline_id: 10453492
    };
    
    console.log('📤 Payload FORMATO FINAL:', JSON.stringify(payload, null, 2));
