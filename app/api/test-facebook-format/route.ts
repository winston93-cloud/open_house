...
export async function GET(request: NextRequest) {
  try {
    console.log('🧪 TEST FORMATO FACEBOOK: Sin arrays...');
    ...
    // Payload EXACTAMENTE como Facebook (sin arrays)
    const payload = {
      name: "FACEBOOK FORMAT TEST"
    };
    
    console.log('📤 Payload FORMATO FACEBOOK:', JSON.stringify(payload, null, 2));
