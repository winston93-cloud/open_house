  ...
  try {
    ...
    if (formData.telefono) {
      try {
        ...
        let mensaje = '';
        if (formData.nivelAcademico === 'maternal' || formData.nivelAcademico === 'kinder') {
          mensaje = `Open House 2025 confirmado para ${formData.nombreAspirante}. Recordatorio por email 1 dia antes. WhatsApp: 833 347 4507`;
        } else {
          mensaje = `Open House 2025 confirmado para ${formData.nombreAspirante}. Recordatorio por email 1 dia antes. WhatsApp: 833 437 8743`;
        }
