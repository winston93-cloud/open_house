            ...
            <div class="content">
                ...
                <div class="cta-section">
                    ...
                    <div style="margin-top: 20px; text-align: center;">
                        <a href="https://open-house-chi.vercel.app/confirmar-nuevo?id=${id}&confirmacion=confirmado" style="display: inline-block; padding: 15px 30px; margin: 5px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3);">
                            ✅ Sí, asistiré
                        </a>
                        <a href="https://open-house-chi.vercel.app/confirmar-nuevo?id=${id}&confirmacion=no_confirmado" style="display: inline-block; padding: 15px 30px; margin: 5px; background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 12px rgba(239, 68, 68, 0.3);">
                            ❌ No podré asistir
                        </a>
                    </div>
