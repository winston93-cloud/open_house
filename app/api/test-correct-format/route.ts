...
export async function GET(request: NextRequest) {
  try {
    console.log('🧪 TEST FORMATO CORRECTO: Array con objeto...');
    ...
    // Payload CORRECTO: Array con un objeto
    const payload = [
      {
        name: "FORMATO CORRECTO TEST",
        price: 0,
        pipeline_id: 10453492
      }
    ];
    
    console.log('📤 Payload FORMATO CORRECTO:', JSON.stringify(payload, null, 2));
