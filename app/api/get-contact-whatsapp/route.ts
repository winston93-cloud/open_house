...
export async function GET() {
  try {
    ...
    // Contact ID de JUANITA HERNANDEZ: 20713324 (del lead #24933112)
    const contactId = 20713324;
    
    const response = await fetch(`https://winstonchurchill.kommo.com/api/v4/contacts/${contactId}`, {
      method: 'GET',
      headers: {
    ...
    // Extract phone field
    const phoneField = data.custom_fields_values?.find((field: any) => field.field_id === 557098);
