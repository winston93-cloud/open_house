...
// Obtener todos los alumnos de Secundaria
$query = "SELECT * FROM alumno WHERE nivel = 'Secundaria' ORDER BY grado ASC, nombre ASC";
...
<head>
    ...
    <title>Secundaria - Gestión Administrativa</title>
