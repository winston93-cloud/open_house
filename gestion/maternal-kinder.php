...
// Obtener todos los alumnos de Maternal y Kinder
$query = "SELECT * FROM alumno WHERE nivel IN ('Maternal', 'Kinder', 'Preescolar') ORDER BY nombre ASC";
...
<head>
    ...
    <title>Maternal y Kinder - Gestión Administrativa</title>
