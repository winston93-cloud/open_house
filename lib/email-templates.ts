...
export function getEmailTemplate5d(nombre: string, plantel: string = 'winston'): string {
  ...
  return `
    ...
    <body style="margin: 0; padding: 0; font-family: Arial, Helvetica, sans-serif; background-color: #e0e0e0;">
      <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #e0e0e0; padding: 50px 20px;">
        <tr>
          <td align="center">
            <!-- Tarjeta principal -->
            <table width="380" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 25px; box-shadow: 0 10px 35px rgba(0,0,0,0.15); max-width: 90%;">
              
              <!-- Logo Winston -->
              <tr>
                <td style="padding: 25px 30px 5px 30px; text-align: right;">
                  <span style="font-family: Arial, sans-serif; font-size: 28px; font-weight: bold; color: #0088CC; letter-spacing: -1px;">Winston</span>
                </td>
              </tr>
              
              <!-- Contenido principal -->
              <tr>
                <td style="padding: 20px 30px 35px 30px; text-align: center;">
                  
                  <!-- DESCUENTO ESPECIAL -->
                  <h1 style="font-family: Arial, sans-serif; color: #E53935; font-size: 42px; font-weight: bold; margin: 0 0 30px 0; line-height: 1.0; letter-spacing: -1px;">
                    DESCUENTO<br>ESPECIAL
                  </h1>
                  
                  <!-- AL INICIAR TU PROCESO DE ADMISIÓN HOY! -->
                  <p style="font-family: Arial, sans-serif; color: #0066CC; font-size: 15px; font-weight: bold; margin: 0 0 3px 0;">
                    AL INICIAR TU PROCESO
                  </p>
                  <p style="font-family: Arial, sans-serif; color: #00A8E1; font-size: 18px; font-weight: bold; margin: 0 0 3px 0;">
                    DE ADMISIÓN
                  </p>
                  <p style="font-family: Arial, sans-serif; color: #00A8E1; font-size: 38px; font-weight: bold; margin: 0 0 35px 0; letter-spacing: -1px;">
                    HOY!
                  </p>
                  
                  <!-- Escríbenos al -->
                  <p style="font-family: Arial, sans-serif; color: #0066CC; font-size: 14px; font-weight: bold; margin: 0 0 8px 0; text-align: left;">
                    Escríbenos al
                  </p>
                  
                  <!-- Número WhatsApp -->
                  <p style="margin: 0 0 25px 0; text-align: left;">
                    <a href="https://wa.me/${whatsappNumber}" style="font-family: Arial, sans-serif; color: #0066CC; font-size: 24px; font-weight: bold; text-decoration: none;">
                      <span style="font-size: 20px;">💬</span> ${whatsappDisplay}
                    </a>
                  </p>
                  ...
                  <!-- DA EL PRIMER PASO -->
                  <p style="font-family: Arial, sans-serif; color: #0066CC; font-size: 18px; font-weight: bold; margin: 0 0 5px 0; text-align: left;">
                    DA EL PRIMER PASO
                  </p>
                  <p style="font-family: Arial, sans-serif; color: #0066CC; font-size: 14px; margin: 0 0 35px 0; line-height: 1.4; text-align: left;">
